...
public:
  ...
  void askADC_SingleEnded(uint8_t channel);
  int16_t readADC();
  int16_t readAndNextADC_SingleEnded(uint8_t channel);
  ...
  int16_t read_and_ask_ADC_Differential_2_3();
  int16_t read_and_ask_ADC_Differential_0_1();
  int16_t getADC_SingleEnded(uint8_t channel);
